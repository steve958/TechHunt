...
const AdminPanelPage = () => {
  ...
  const [isCandidates, setIsCanditates] = useState("true" === localStorage.getItem("isCandidates"))
  const [isCompanies, setIsCompanies] = useState("true" === localStorage.getItem("isCompanies"))
...
const changeIsCompanies=(e)=>{
  ...
  return (
    ...
    <header>
    <button onClick={logOut}>Logout</button></header>
